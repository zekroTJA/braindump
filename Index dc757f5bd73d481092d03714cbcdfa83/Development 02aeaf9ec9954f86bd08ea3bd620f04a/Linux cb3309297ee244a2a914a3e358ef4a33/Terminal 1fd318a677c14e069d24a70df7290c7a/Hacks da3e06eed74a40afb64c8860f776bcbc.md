...
When you are using `zsh`, you need to enable this via the following option *([source](https://superuser.com/questions/352788/how-to-prevent-a-command-in-the-zshell-from-being-saved-into-history))*.
