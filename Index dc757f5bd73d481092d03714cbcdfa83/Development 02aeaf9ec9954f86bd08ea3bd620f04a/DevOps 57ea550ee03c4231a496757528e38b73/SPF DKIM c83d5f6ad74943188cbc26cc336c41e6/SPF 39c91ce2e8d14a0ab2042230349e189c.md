...
- SPFv1 protects the *envelope sender address* (aka *return-path*), which is used during the transport from mail-server to mail-server to return a message on failed delivery.
